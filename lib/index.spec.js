...
describe('verify test suite loads all json test files', function () {
  ...
  const requiredPattern = { glob: testFilesPath + '/tests/%s/**/*.json', ignore: testFilesPath + '/tests/%s/optional/*.json' }
  const optionalPattern = testFilesPath + '/tests/%s/optional/*.json'
  const minPattern = testFilesPath + '/tests/%s/**/min*.json'
